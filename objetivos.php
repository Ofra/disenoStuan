	...
	<div id="objetivo_part">
		<h3><em>Objetivo Particular</em></h3>
			...
			<ul>
				...
				<strong><li class="objli">4.- La defensa permanente de las universidades públicas, de su autonomía, el replanteamiento continuo de sus objetivos y la democratización de la enseñanza.</strong>
</li>		
			</ul>
...
<?php
	//desde cierre de contenedor principal hasta fin de pagina incluyendo footer
